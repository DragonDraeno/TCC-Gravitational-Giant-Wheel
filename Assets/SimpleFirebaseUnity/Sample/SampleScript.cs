...
public class SampleScript : MonoBehaviour
{
    ...
    void Start()
    {
        nomeJogador = GameObject.Find("nomePontos").GetComponent<nomePontos>().nome;
        textMesh.text = "";
	...
	IEnumerator Tests()
	{
		...
		Firebase firebase = Firebase.CreateNew ("tcc-gw.firebaseio.com", "pdGaQJ8tKwtuQdtQJm8clFWxaFiMbZvpygc7NVc3");
        ...
        //firebaseQueue.AddQueuePush(firebase, GetSampleScoreBoard(), FirebaseParam.Empty.PrintSilent());
        firebaseQueue.AddQueuePush(firebase.Child("Score"), GetSampleScoreBoard());
        yield return firebaseQueue;//espera o retorno de sucesso do cadastro
        ...
        firebase.Child("Score", true).GetValue("Pontos");
	...
	{
        Dictionary<string, object> jogador = new Dictionary<string, object>();
        Dictionary<string, object> scor = new Dictionary<string, object>();
        ...
        {
            float pontos = GameObject.Find("personagem").GetComponent<personagemFisica>().pontos;
            print(pontos);
            jogador.Add("Tempo", "$_520_$");
            jogador.Add("Pontos", "#_" + pontos + "_#");
        }
        //      p1.Add ("name", "simple");
        //p1.Add("score", 80);
        ...
        if (nomeJogador == "")
        {
            scor.Add("%_Nome" + x + "_%", jogador);
        }
        else {
            scor.Add("%_" + nomeJogador + "_%", jogador);
        }
